...
class _SearchResultsState extends State<SearchResults> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: headerGeneral("Search Results"),
      body: Stack(
        children: <Widget>[
          ListView(
            ...
            children: <Widget>[
              ...
              StreamBuilder(
                stream:
                    productsRef.where("instock", isEqualTo: true).snapshots(),
                builder: (context, snapshot) {
                  ...
                  if (!snapshot.hasData) {
                    ...
                    snapshot.data.documents.forEach((x) {
                      String name = x["foodName"];
                      String desc = x["foodDesc"];
                      print(desc);
                      if (name
                              .toLowerCase()
                              .contains(widget.searchKey.toLowerCase()) ||
                          desc
                              .toLowerCase()
                              .contains(widget.searchKey.toLowerCase()) ||
                          name.toLowerCase() ==
                  ...
                  if (tempList.isEmpty) {
                    return Container(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          "Did not find any item related to ${widget.searchKey}",
